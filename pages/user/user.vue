		...
		<view class="user-section">
			...
			<view class="user-info-box">
				<view class="portrait-box">
					<image class="portrait" src="/static/sharemenu/wechatmoments.png"></image>
				</view>
				<view class="info-box">
					<view class="username">用户昵称</view>
					<view class="invitecode">邀请码 456123461</view>
				</view>
			</view>
			<view class="vip-card-box">
				...
				<text class="e-m">Yi Jia VIP</text>
				<text class="e-b">每月20号可提现上月收益</text>
			</view>
		</view>
    ...
    export default {
		...
		onNavigationBarButtonTap(e) {
			...
			if(e.index === 1){
				...
				//消息按钮增加提示
				this.setStyle(1,true,'10');
			}
		},
    }  
</script>  
<style lang='scss'>
	/* @mixin public-flex($spindle:space-between,$crossaxis:center) {
		display: flex;
		justify-content: $spindle;
		align-items: $crossaxis;
	} */
	/* .test{
		@include public-flex(space-around);
	} */
	%flex-center {
	 display:flex;
