import requestURL from './requestURL1.js'
import request from './fetch1.js'
/**
 * 请求API
 */
export default {
	...
	test: async function(prams) {
	    let response = await request.Fetch(requestURL.test,prams,'GET')
	    return response;
	},
	user: async function(prams) {
	    let response = await request.Fetch(requestURL.user,prams,'GET')
	    return response;
	},
